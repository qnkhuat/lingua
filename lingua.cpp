...
llvm::Function *PrototypeAST::codegen() {
	...
	llvm::Function *F = llvm::Function::Create(
			FT, 
			llvm::Function::ExternalLinkage, // because this is a protype. External Linkage mean defined some where else
			Name, 
			TheModule.get());
...
llvm::Function *FunctionAST::codegen(){
	// First, check for an existing function from previous 'extern' declaration
